		...
		<main className="font-poppins grid h-full place-items-center">
			<div className="grid place-items-center px-4 py-16 xl:grid-cols-2 xl:gap-24">
				<div className="flex max-w-md flex-col items-center text-center xl:order-2 xl:items-start xl:text-left">
					...
					<p className="text-md mt-6 py-4">
						<a
							className="button rounded-sm border-2 border-accent bg-inherit p-2 text-xl font-bold text-[#4f9768] hover:bg-accent  hover:text-black dark:hover:text-white"
							href="https://savvycal.com/skruzel/autoetl"
							target="_blank"
							rel="noreferrer"
							data-savvycal-embed
						>
							Geek out with the team
						</a>
					</p>
				</div>
